...
#define WCIN_STATUS_UVLO	0
#define WCIN_STATUS_OVLO		2
#define WCIN_STATUS_INPUT_LIMITED		3
#define WCIN_STATUS_INPUT_SWITCH_OFF	4
#define WCIN_STATUS_VALID	5
...
/* S2MU005_CHG_CTRL14 */
#define BAT2SYS_SWITCH_SHIFT		7
#define BAT2SYS_SWITCH_MASK		BIT(BAT2SYS_SWITCH_SHIFT)
